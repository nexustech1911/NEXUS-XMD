...
module.exports = {
  SESSION_ID: process.env.SESSION_ID || "nexus~YYQgSIDa#ebmTbiV54CVU4anslYVPTXKGCR0hQPI2nU9SRCCnwxM",
  ...
  BOT_NAME: process.env.BOT_NAME || "NEXUS-XMD2",
  STICKER_NAME: process.env.STICKER_NAME || "NEXUS-XMD",
  CUSTOM_REACT: process.env.CUSTOM_REACT || "false",
  CUSTOM_REACT_EMOJIS: process.env.CUSTOM_REACT_EMOJIS || "😝,💖,💀,❤️‍🩹,❤️,🧡,🤪,💚,🔪,💜,🫩,😤,👺,👹,👻,😹,🤎,🖤,🤍",
  DELETE_LINKS: process.env.DELETE_LINKS || "true",
  OWNER_NUMBER: process.env.OWNER_NUMBER || "2349136279816",
  OWNER_NAME: process.env.OWNER_NAME || "S.N.M",
  DESCRIPTION: process.env.DESCRIPTION || "*© ᴘᴏᴡᴇʀᴇᴅ ʙʏ S.N.M*",
  ...
  DEV: process.env.DEV || "2349136279816",
